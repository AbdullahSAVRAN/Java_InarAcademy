...
//import chapters.chapter10.MyRectangle2D;
...
public class Exercise10_15 {
    public static void main(String[] args) {
        ...
        double[][] points = createPoints(numOfPoints, input);
        MyRectangle2D rectangle2D = getRectangle(points);
        System.out.println("BOUNDING : " + rectangle2D.toString());
    }
    ...
    public static MyRectangle2D getRectangle(double[][] points) {
        double[] boundingPoints = getBoundingPoints(points);
