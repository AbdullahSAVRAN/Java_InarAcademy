...
public class Exercises3_28 {
	...
	public static void main(String[] args) {
		...
		double rectangleRight2 = x2 + (width / 2);
		double rectangleLeft2 = x2 - (width / 2);
		double rectangleTop2 = y2 + (height / 2);
		double rectangleBottom2 = y2 - (height / 2);
